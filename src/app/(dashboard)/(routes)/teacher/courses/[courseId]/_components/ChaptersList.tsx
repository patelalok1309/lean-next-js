                        ...
                        {chapters.map((chapter, index) => (
                            ...
                            >
                                {(provided) => (
                                    <div
                                        className={cn(
                                            "flex items-center gap-x-2 bg-slate-200 dark:bg-slate-950 dark:text-sky-700  dark:border-dotted dark:border-sky-100 border-slate-200 border text-slate-700 rounded-md mb-4 text-sm",
                                            chapter.isPublished &&
